var ParallelEventEmitter = require('../ParallelEventEmitter');
...
describe('Concerto', function() {
  ...
  describe('Component', function() {
    ...
    describe('Event', function() {
      ...
      describe('ParallelEventEmitter', function() {

        it('should inherit from EventEmitter', function() {
          var emitter = new ParallelEventEmitter();
        ...
        it('should register listener with .on', function(done) {
          ...
          emitter
            ...
            .parallel('foo', 1, 3, function(err, results) {
        ...
        it('should register listener with .once', function(done) {
          ...
          emitter
            ...
            .parallel('foo', 5, function(err, results) {
              results.should.be.eql([6, 10]);
              emitter.parallel('foo', 5, function(err, results) {
        ...
        it('should pass parameters to the listeners', function(done) {
          ...
          emitter
            ...
            .parallel('foo', 2, function(err, results) {
        ...
        it('should manage synchronous and asynchronous listeners', function(done) {
          ...
          emitter
            ...
            .parallel('foo', 2, 3, function(err, results) {
